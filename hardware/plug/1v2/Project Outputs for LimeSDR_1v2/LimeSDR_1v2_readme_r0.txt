...
-----------------
	...
	- Throughole vias are covered in the following files:
						...
						LimeSDR_1v2-RoundHoles.TXT															Top									Bottom
	- Slotholes are covered in the following files:
						LimeSDR_1v2-SlotHoles.TXT															Top									Bottom	
...
---------------
		...
		LimeSDR_1v2.GTL				Top (Signal)
		LimeSDR_1v2.G1				L2  (Signal)
		LimeSDR_1v2.G2				L3  (Signal)
		LimeSDR_1v2.G3				L4  (Signal)
		LimeSDR_1v2.G4				L5  (Signal)
		LimeSDR_1v2.G5				L6  (Signal)
		LimeSDR_1v2.G6				L7  (Signal)	
		LimeSDR_1v2.G7				L8  (Signal)
		LimeSDR_1v2.G8				L9  (Signal)
		LimeSDR_1v2.G9				L10 (Signal)
		LimeSDR_1v2.G10				L11 (Signal)
		LimeSDR_1v2.GBL				Bottom (Signal)

		 
		LimeSDR_1v2.GPB				Bottom Pad Master
		LimeSDR_1v2.GPT				Top Pad Master

		LimeSDR_1v2.GTO				Top Overlay
		LimeSDR_1v2.GTP				Top Paste
		LimeSDR_1v2.GTS				Top Solder

 
		LimeSDR_1v2.GBS				Bottom Solder
		LimeSDR_1v2.GBP				Bottom Paste
		LimeSDR_1v2.GBO				Bottom Overlay


		LimeSDR_1v2.GM1				Mechanical 1 (Board Cutout)


		LimeSDR_1v2.GM14				ASM BOT (Assembly bottom)
		LimeSDR_1v2.GM15				ASM TOP (Assembly top)
